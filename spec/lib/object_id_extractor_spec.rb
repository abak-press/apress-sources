...
RSpec.describe Apress::Sources::ObjectIdExtractor, '#call' do
  ...
  it { expect { described_class.new(:company).call(object: {user_id: 1}) }.to raise_error(StandardError) }
  it { expect { described_class.new(:company).call(object: nil) }.to raise_error(StandardError) }
  it do
    object = -> { 2 }
